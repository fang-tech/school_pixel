...
var ASM_CONSTS = {
  3746976: function() {return Module.window ? 1 : 0;},  
 3747010: function() {var win = Module.window ? Module.window : window; var AudioContext = win.AudioContext || win.webkitAudioContext; var infocontext = new AudioContext(); if (!infocontext) { return 0; } var inforate = infocontext.sampleRate; infocontext.close(); return inforate;},  
 3747274: function() {Module.mInputRegistered = false;},  
 3747311: function() {var win = Module.window ? Module.window : window; var AudioContext = win.AudioContext || win.webkitAudioContext; Module.context = new AudioContext(); if (!Module.context) { return 0; } Module.FMOD_JS_MixFunction = Module["cwrap"]('FMOD_JS_MixFunction', 'void', ['number']); return Module.context.sampleRate;},  
 ...
 3759626: function() {performance.now = Module['emscripten_get_now_backup'];}
  ...
  function _WebGLInputBridge_Hide() {
  ...
  function _WebGLInputBridge_Show(objectNamePtr, methodNamePtr, initialTextPtr) {
...
var asmLibraryArg = {
  ...
  "WebGLInputBridge_Hide": _WebGLInputBridge_Hide,
  "WebGLInputBridge_Show": _WebGLInputBridge_Show,
